				...
				<div style="margin: auto;text-align: center;">
					...
					<form action="" method="post">
						<table id="table1" style="border:1px solid;margin: auto;text-align: center;">
							<tr>
								<td width=106px;>公司</td>
								<td width=106px;>Na</td>
								<td width=106px;>Ga</td>
								<td width=106px;>V</td>
								<td width=106px;>Fe</td>
								<td width=106px;>S</td>
								<td width=106px;>灰石</td>
								<td width=106px;>挥发份</td>
								<td width=106px;>价格</td>
								<td width=106px;>选择</td>
							</tr>
							<c:forEach items="${shoplist}" var="S">
								<tr>
									...
									<td>${S.huifafeng }</td>
									<td>${S.money }</td>
									<td><input name="shop" type="checkbox" value="${S.id }" onclick="return false;" checked="checked"/></td>
								</tr>
							</c:forEach>

							<tr bgcolor="black" style="color:white">
								<td>定份</td>
								<td bgcolor="black" style="color:white;" colspan=7><input type="text" style="color: black" name="fenshu" width=782px; value="5">&nbsp;&nbsp;&nbsp;设置上涨幅度，越小越精细（0.5 ~ 5）</td>
					...
					<SCRIPT language=JavaScript>
						function login(form){
							...
							if (num >= 0.5 && num <=5 ) {
								...
								var str = a.toString();
								form.action = getBasePath() + "/Demo/shejipeiliangbiaoaction?idlist=" + str + "&fenshu=" + str2;
								form.submit;
							}else {
								alert("请核对幅度！");
