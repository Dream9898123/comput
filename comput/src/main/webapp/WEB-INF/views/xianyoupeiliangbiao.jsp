                    ...
                    <div class="head-t">
                        ...
                        <div class="header_right" style="margin-top: 40px;">
                            <div id="loginContainer">
                                <a onclick="window.history.go(-1)" id="loginButton"
                                   style="float: right; margin-right: 40px;"><span>返回</span></a>
                            </div>
                        </div>
                        <div class="clearfix"></div>
                    </div>
                ...
                <div style="margin: auto;text-align: center;">
                    ...
                    <form action="" method="post">
                        <%-- <c:forEach items="${peibimulu}" var="S">
                            <input name="shop" type="radio" value="${S.id }" />${S.peiBiMingZi }<br>
                        </c:forEach> --%>
                        <p></p>
                    ...
                    <SCRIPT language=JavaScript>
                        function login(form) {
                            ...
                            /*  if(flag){ */
                            var str = a.toString();
                            form.action = getBasePath() + "/Demo/xianyoupeiliangbiaoaction?PEILIANGID=${PEILIANGID}";
                            form.submit;
                            /* }else{
                                alert("请选择配量表！！！");
                            } */
            ...
            <ul id="menu">
                ...
                <li><a href="#"><i
                    ...
                    <ul>
                        ...
                        <li><a
                                href="${pageContext.request.contextPath}/Demo/updateshoppage?shopId=-1&update=-1">修改原产地</a>
                        </li>
                    </ul>
                </li>
            </ul>
