...
<%
	if ((String) request.getAttribute("info") == "deletesuccess") {
%>
<script>
	alert("删除成功！");
</script>
<%
	...
	} else if ((String) request.getAttribute("info") == "deletefalse") {
%>
<script>
	alert("删除失败！");
</script>
			...
			<div class="inner-content">
				...
				<div class="content" style="padding-top: 0px;">
					<div style="margin: auto; text-align: center;">
						<h1>请选择标准</h1>
						<a href="${pageContext.request.contextPath}/Demo/indexpage"><button
								value="灵活配量表">灵活配量表</button></a> <a
							href="${pageContext.request.contextPath}/Demo/shejipeiliangbiaopage"><button
								value="设计配量表">设计配量表</button></a> <a
							href="${pageContext.request.contextPath}/Demo/xianyoupeiliangbiaopage"><button
								value="已有配量表">已有配量表</button></a>
						<p></p>
						<form action="" method="post">
							<table id="table1"
								...
								<tr>
									<td bgcolor="black" style="color: white">定额：</td>
									...
									<td><input type="text" name="huifafeng"
										style="width: 60px"></td>
									<td></td>
									<td><input type="button" value="全选" onclick="setAll()" /></td>
								</tr>
								<tr>
									<td bgcolor="black" style="color: white">定份：</td>
									<td bgcolor="black" colspan=7><input type="text"
										name="fenshu" width=782px;></td>
						...
						<SCRIPT language=JavaScript>
							function login(form) {
								...
								var str = a.toString();
								form.action = getBasePath()
										+ "/Demo/resultpage?idlist=" + str
										+ "&fenshu=" + str2;
								form.submit;
