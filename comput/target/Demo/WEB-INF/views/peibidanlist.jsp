				...
				<div style="margin: auto; text-align: center;">
					...
					<table id="table1"
						...
						<tr>
							<td >配比单名称</td>
							<td >公司</td>
							<td style="width: 80px">配比</td>
							<td style="width: 70px">Na</td>
							<td style="width: 70px">Ga</td>
							<td style="width: 70px">V</td>
							<td style="width: 70px">Fe</td>
							<td style="width: 70px">S</td>
							<td style="width: 70px">灰石</td>
							<td style="width: 70px">挥发份</td>
							<td style="width: 70px">价格</td>
							<td style="width: 104px">操作</td>
						</tr>
						<c:forEach items="${pbdlist}" var="S">
							<tr>
								<td>${S.pbdName}</td>
								<td>${S.conpanyname }</td>
								<td>${S.peibi}</td>
								...
								<td>${S.money }</td>
								<td>
									<a href="${pageContext.request.contextPath}/Demo/peibidanlistpage?pbdName=${S.pbdName }"><button>查看</button></a>
                                    <a href="${pageContext.request.contextPath}/Demo/deletepeibidan?pbdName=${S.pbdName }"><button>删除</button></a>
                                </td>
							</tr>
						</c:forEach>
					</table>
