							...
							<table id="table1"
								...
								<c:forEach items="${shoplist}" var="S">
									<tr>
										...
										<td>${S.money }</td>
										<td>
											<button href="${pageContext.request.contextPath}/Demo/updateshoppage?shopId=${S.id }&update=1">修改</button>
											<button href="${pageContext.request.contextPath}/Demo/updateshoppage?shopId=${S.id }&update=0" onClick="return confirm('确定删除?');">删除</button>
										</td>
									</tr>
								</c:forEach>
							</table>
