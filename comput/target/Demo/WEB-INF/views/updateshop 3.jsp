							...
							<table id="table1"
								...
								<c:forEach items="${shoplist}" var="S">
									<tr>
										...
										<td>${S.money }</td>
										<td>
											<a href="${pageContext.request.contextPath}/Demo/updateshoppage?shopId=${S.id }&update=1"><button>修改</button></a>
											<a href="${pageContext.request.contextPath}/Demo/updateshoppage?shopId=${S.id }&update=0"><button onClick="return confirm('确定删除?');">删除</button></a>
										</td>
									</tr>
								</c:forEach>
							</table>
