...
<%--                                    </c:if>--%>
                                            ...
                                            <div class="fo-top">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-8 ctl">
                                                        <input type="number" class="form-control1" name="Na">
                                                    </div>
                                                    <div class="col-sm-2 hp">
                                            ...
                                            <div class="fo-top">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-8 ctl">
                                                        <input type="number" class="form-control1" name="Ga" >
                                                    </div>
                                                    <div class="col-sm-2 hp">
                                                        <p class="help-block">(常量，无填0)</p>
                                                    </div>
                                            ...
                                            <div class="fo-top">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-8 ctl">
                                                        <input type="number" class="form-control1" name="V" >
                                                    </div>
                                                    <div class="col-sm-2 hp">
                                                        <p class="help-block">(常量，无填0)</p>
                                                    </div>
                                            ...
                                            <div class="fo-top">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-8 ctl">
                                                        <input type="number" class="form-control1" name="Fe" >
                                                    </div>
                                                    <div class="col-sm-2 hp">
                                                        <p class="help-block">(常量，无填0)</p>
                                                    </div>
                                            ...
                                            <div class="fo-top">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-8 ctl">
                                                        <input type="number" class="form-control1" name="S" >
                                                    </div>
                                                    <div class="col-sm-2 hp">
                                                        <p class="help-block">(常量，无填0)</p>
                                                    </div>
                                            ...
                                            <div class="fo-top">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-8 ctl">
                                                        <input type="number" class="form-control1" name="shihui" >
                                                    </div>
                                                    <div class="col-sm-2 hp">
                                                        <p class="help-block">(常量，无填0)</p>
                                                    </div>
                                            ...
                                            <div class="fo-top">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-8 ctl">
                                                        <input type="number" class="form-control1" name="huifafeng" >
                                                    </div>
                                                    <div class="col-sm-2 hp">
                                                        <p class="help-block">(常量，无填0)</p>
                                                    </div>
                                            ...
                                            <div class="fo-top">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-8 ctl">
                                                        <input type="number" class="form-control1" name="money" >
                                                    </div>
                                                    <div class="col-sm-2 hp">
