...
<%--                                    </c:if>--%>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-8 ctl">
                                                        <input type="text" class="form-control1" name="companyName"
                                                               placeholder="简写" value="">${oldshop.companyName}
                                                    </div>
                                            ...
                                            <div class="fo-top">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-8 ctl">
                                                        <input type="number" class="form-control1" name="Na">${oldshop.Na}
                                                    </div>
                                                    <div class="col-sm-2 hp">
                                            ...
                                            <div class="fo-top">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-8 ctl">
                                                        <input type="number" class="form-control1" name="Ga" >${oldshop.Ga}
                                                    </div>
                                                    <div class="col-sm-2 hp">
                                                        <p class="help-block">(常量，无填0)</p>
                                                    </div>
                                            ...
                                            <div class="fo-top">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-8 ctl">
                                                        <input type="number" class="form-control1" name="V" >${oldshop.V}
                                                    </div>
                                                    <div class="col-sm-2 hp">
                                                        <p class="help-block">(常量，无填0)</p>
                                                    </div>
                                            ...
                                            <div class="fo-top">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-8 ctl">
                                                        <input type="number" class="form-control1" name="Fe" >${oldshop.Fe}
                                                    </div>
                                                    <div class="col-sm-2 hp">
                                                        <p class="help-block">(常量，无填0)</p>
                                                    </div>
                                            ...
                                            <div class="fo-top">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-8 ctl">
                                                        <input type="number" class="form-control1" name="S" >${oldshop.S}
                                                    </div>
                                                    <div class="col-sm-2 hp">
                                                        <p class="help-block">(常量，无填0)</p>
                                                    </div>
                                            ...
                                            <div class="fo-top">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-8 ctl">
                                                        <input type="number" class="form-control1" name="shihui" >${oldshop.shihui}
                                                    </div>
                                                    <div class="col-sm-2 hp">
                                                        <p class="help-block">(常量，无填0)</p>
                                                    </div>
                                            ...
                                            <div class="fo-top">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-8 ctl">
                                                        <input type="number" class="form-control1" name="huifafeng" >${oldshop.huifafeng}
                                                    </div>
                                                    <div class="col-sm-2 hp">
                                                        <p class="help-block">(常量，无填0)</p>
                                                    </div>
                                            ...
                                            <div class="fo-top">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-8 ctl">
                                                        <input type="number" class="form-control1" name="money" >${oldshop.money}
                                                    </div>
                                                    <div class="col-sm-2 hp">
...
<script language=JavaScript type="text/javascript">
    function checkForm(form){
        ...
        console.log("last"+money)
        // 将数字字符拼接起来一起检查
        var tempNumber = Na.concat(Ga,V,Fe,S,shihui,huifafeng,money)
        console.log("tempNumber"+tempNumber.length)
