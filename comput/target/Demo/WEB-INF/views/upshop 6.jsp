...
<%--                                    </c:if>--%>
                                            <div class="fo-top">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-8 ctl">
                                                        <input type="hidden" name="id" value="${oldshop.id}">
                                                        <input type="text" class="form-control1" name="companyName"
                                                               placeholder="${oldshop.companyName}" value="">
                                                    </div>
                                            ...
                                            <div class="fo-top">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-8 ctl">
                                                        <input type="number" class="form-control1" name="Na" placeholder="${oldshop.na}">
                                                    </div>
                                                    <div class="col-sm-2 hp">
                                                        <p class="help-block">(常量，无填0)</p>
                                                    </div>
                                                    <div class="clearfix"></div>
                                                </div>
                                            </div>
                                            <div class="fo-top">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-8 ctl">
                                                        <input type="number" class="form-control1" name="Ga" placeholder="${oldshop.ga}">
                                                    </div>
                                                    <div class="col-sm-2 hp">
                                                        <p class="help-block">(常量，无填0)</p>
                                                    </div>
                                            ...
                                            <div class="fo-top">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-8 ctl">
                                                        <input type="number" class="form-control1" name="V" placeholder="${oldshop.v}">
                                                    </div>
                                                    <div class="col-sm-2 hp">
                                                        <p class="help-block">(常量，无填0)</p>
                                                    </div>
                                            ...
                                            <div class="fo-top">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-8 ctl">
                                                        <input type="number" class="form-control1" name="Fe" placeholder="${oldshop.fe}">
                                                    </div>
                                                    <div class="col-sm-2 hp">
                                                        <p class="help-block">(常量，无填0)</p>
                                                    </div>
                                            ...
                                            <div class="fo-top">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-8 ctl">
                                                        <input type="number" class="form-control1" name="S" placeholder="${oldshop.s}">
                                                    </div>
                                                    <div class="col-sm-2 hp">
                                                        <p class="help-block">(常量，无填0)</p>
                                                    </div>
                                            ...
                                            <div class="fo-top">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-8 ctl">
                                                        <input type="number" class="form-control1" name="shihui" placeholder="${oldshop.shihui}">
                                                    </div>
                                                    <div class="col-sm-2 hp">
                                                        <p class="help-block">(常量，无填0)</p>
                                                    </div>
                                            ...
                                            <div class="fo-top">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-8 ctl">
                                                        <input type="number" class="form-control1" name="huifafeng" placeholder="${oldshop.huifafeng}">
                                                    </div>
                                                    <div class="col-sm-2 hp">
                                                        <p class="help-block">(常量，无填0)</p>
                                                    </div>
                                            ...
                                            <div class="fo-top">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-8 ctl">
                                                        <input type="number" class="form-control1" name="money" placeholder="${oldshop.money}">
                                                    </div>
                                                    <div class="col-sm-2 hp">
                                                        <p class="help-block">(人民币，无填0)</p>
                                                    </div>
                                                    <div class="clearfix"></div>
                                                </div>
                                            </div>
                                            <div class="fo-top">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-8 ctl">
                                                        <input class="form-control1" type="submit" style="color: white;background: #252525;" onclick="checkForm(this.form)"></input>
                                                    </div>
                                                    <div class="col-sm-2 hp">
...
<script language=JavaScript type="text/javascript">
    function checkForm(form){
        ...
        var Na =document.getElementsByName("Na")[0].value;
        var Ga =document.getElementsByName("Ga")[0].value
        var V =document.getElementsByName("V")[0].value
        var Fe =document.getElementsByName("Fe")[0].value
        var S =document.getElementsByName("S")[0].value
        var shihui =document.getElementsByName("shihui")[0].value
        var huifafeng =document.getElementsByName("huifafeng")[0].value
        var money =document.getElementsByName("money")[0].value;
        // 将数字字符拼接起来一起检查
        var tempNumber = Na.concat(Ga,V,Fe,S,shihui,huifafeng,money)
        if (companyName.length <= 2 && companyName.length > 0){
            if(!isNaN(tempNumber) && tempNumber.length >= 8){
                // 提交数据
                    form.action=getBasePath()+"/Demo/upshoppage";
                form.submit;
                // return true;
            }else {
                // 弹出提示
