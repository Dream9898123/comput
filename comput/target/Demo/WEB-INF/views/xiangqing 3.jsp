    ...
    <table style="border:1px solid;align: center;margin: auto;text-align: center;">
        ...
        <tr>
         ...
         <tr style="background-color: red;color:white;">
            ...
            <td style="width: auto;border:1px solid;background: white"><c:if test="${keep}"><input style="color:white;background-color: red;width:100%;" value="收 藏" type="button" onclick="pbdName()" /></c:if></td>
        </tr>
         ...
         <tr style="background-color: green;color:white;">
            ...
            <td style="width: auto;border:1px solid;background: white"><c:if test="${keep}"><input style="color:white;background-color: green;width:100%;" value="返 回" type="button" onclick="window.history.go(-1)" /></c:if></td>
